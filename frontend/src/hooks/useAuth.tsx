...
interface AuthContextType {
  ...
  role: AppRole;
  loading: boolean;
  signUp: (email: string, password: string, meta: { full_name: string; department?: string; designation?: string; role: AppRole }) => Promise<{ error: any }>;
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const signUp = async (
    email: string,
    password: string,
    meta: { full_name: string; department?: string; designation?: string; role: AppRole }
  ) => {
